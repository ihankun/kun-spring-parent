...
import com.ihankun.core.cache.lock.LockCallback;
import com.ihankun.core.cache.lock.RedissonLock;
import com.ihankun.core.lock.annotation.Lock;
import com.ihankun.core.spring.api.LockKey;
...
public class LockAspect implements BaseService, Ordered, PriorityOrdered {
    ...
    @Around("@annotation(com.ihankun.core.lock.annotation.Lock)")
