...
//import com.ihankun.core.db.dynamic.bean.DataSourceBuildProperty;
...
//     * @return 数据源
//     */
//    public DataSource createDataSource(String alias, String fullName, String domain) {
//
//        lockers.putIfAbsent(fullName, new Object());
//        synchronized (lockers.get(fullName)) {
...
//                return null;
//            }
//            DataSource target = ((DynamicRoutingDataSource) dataSource).getCurrentDataSources().get(fullName);
//            if (target != null) {
//                return target;
//            }
...
//            log.warn("DataSourceCacheCreator.buildDataSource.v2.addr.miss,property={}", dataSourceBuildProperty);
//            return false;
//        }
//        //使用配置的医院特定密码
//        String newPass = environment.getProperty(pre + property.getUsername() + DS_POINT + dataSourceBuildProperty.getDbMark());
//        if (!StringUtils.isEmpty(newPass)) {
//            log.warn("DataSourceCacheCreator.buildDataSource.v2.try.pass,property={}", dataSourceBuildProperty);
//            if (tryUpdateProperty(property, environment, dataSourceBuildProperty, addr, newPass)) {
//                return true;
//            }
//            log.warn("DataSourceCacheCreator.buildDataSource.v2.try.hospital.pass.fail,property={}", dataSourceBuildProperty);
//        }
//        //密码不空
...
//                return true;
//            }
//            log.warn("DataSourceCacheCreator.buildDataSource.v2.try.pass.fail,property={}", dataSourceBuildProperty);
//        } else {
//            log.warn("DataSourceCacheCreator.buildDataSource.v2.origin.pass.miss,property={}", dataSourceBuildProperty);
//        }
//        //尝试生成密码
//        if (tryGeneratePass(property, environment, dataSourceBuildProperty, addr)) {
//            return true;
//        }
//        log.warn("DataSourceCacheCreator.buildDataSource.v2.try.generate.pass.fail,property={}", dataSourceBuildProperty);
//        return false;
//    }
//
...
//                log.warn("DataSourceCacheCreator.buildDataSource.try.generate.pass.with.empty.env.key!property={},user={}", dataSourceBuildProperty, userName);
//            }
...
//        } else {
//            log.warn("DataSourceCacheCreator.buildDataSource.does.not.try.generate.db.key.is.empty!property={},user={}", dataSourceBuildProperty, userName);
//        }
//        return false;
//    }
//
...
//        log.info("re={}", decryptPass("oigFrbuqF78%m@!g", "h+VF+4R2JLKpio/K6UdTKa5UJgeeb/MyWwGbkRQroTH8BuORuM0D8W7ADDXSFSSw"));
//        log.info("re={}", buildPass("Phz69!Y1@gphOrLK0x@z", "sSEdPXvS5PVQmYt+!naQCkn_!9V812Ap", "dsip_app"));
//    }
//
...
//            } catch (Exception e) {
//                log.info("DataSourceCacheCreator.buildDataSource.pass.decrypt.fail!");
//            }
//        } else {
